...
import { GraduationCap, Send, CheckCircle2, Loader2, User, Mail, Building2 } from "lucide-react";

const ASSESSMENT_FIELDS = [
  { key: "AI_Concept_Knowledge", label: "How would you explain what a Large Language Model (LLM) is?", type: "text", placeholder: "Briefly explain in your own words" },
  { key: "Tool_Proficiency_Midjourney", label: "Rate your proficiency in Midjourney (1-5)", type: "number", min: 1, max: 5 },
  { key: "Tool_Proficiency_ChatGPT", label: "Rate your proficiency in ChatGPT (1-5)", type: "number", min: 1, max: 5 },
  { key: "Workflow_Integration", label: "Have you ever created a custom workflow using multiple AI tools?", type: "select", options: ["Yes, frequently", "Yes, a few times", "No, but I know how", "No, I don't know how"] },
  { key: "Technical_Understanding", label: "Do you understand concepts like 'tokens', 'temperature', or 'top-p'?", type: "select", options: ["Very well", "Somewhat", "Heard of them", "Not at all"] },
];
